    ...
    >
      ...
      <Text style={{ color: "#d6d4d4", fontSize: 16,marginBottom:2}}>{props.title}</Text>
        ...
        <StarRating
              ...
              <Text style={{color: "#d6d4d4",fontSize:16,fontWeight:'bold'}}>{props.rating}</Text>
        </View>
