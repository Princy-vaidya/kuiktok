...
import { View, Text, TouchableOpacity, ScrollView, Dimensions, FlatList, Modal, KeyboardAvoidingView, TextInput, StatusBar, SafeAreaView ,StyleSheet, Alert} from 'react-native';
...
class YourInsights extends Component {
  ...
  editProfilePersonal = async (DOB) => {
    const { UData, selectedspecialization } = this.state
      this.setState({ loading: true })
      ...
      <View style={{ flex: 1, backgroundColor: '#0e0e0e' }}>
        <SafeAreaView >
          <View style={{ alignItems: "center", marginBottom: 10,marginTop:30}}>
            <Text style={{ color: "#f6ff00", fontSize: 20, fontWeight: "bold" }}>YOUR INSIGHTS</Text>
          </View>
          ...
          <View style={{ backgroundColor: "#f6ff00", marginHorizontal: 40, borderRadius: 10, paddingVertical: 10, marginBottom: 40,paddingHorizontal:10 }}>
            ...
            Topics you can relate to and offer perspective from experience.
           </Text>
          </View>
